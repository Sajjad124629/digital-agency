                        ...
                        <div className='flex flex-wrap -mx-4'>
                            <div className='w-full lg:w-1/2 px-4 mb-12 lg:mb-0 flex items-center'>
                                <div className='w-full text-center lg:text-left'>
                                    ...
                                    <div className='max-w-sm mx-auto lg:mx-0'>
                                        <p className='mb-6 text-gray-400 leading-loose'>{data['description']}
                                        </p>
                                        <div>
                            ...
                            <div className='w-full lg:w-1/2 px-4'>
                                <div className='flex flex-wrap lg:mb-4 lg:ml-6'>
                                    <Image width={155} height={240} className='w-full md:w-1/2 lg:w-1/3 h-64 p-2 object-cover rounded-4xl lg:rounded-br-none' src={data['image1']} alt='image1' />
                                    <Image width={327} height={240} className='w-full md:w-1/2 lg:w-2/3 h-64 p-2 object-cover rounded-4xl lg:rounded-bl-none' src={data['image2']} alt='image2' />
                                </div>
                                <div className='flex flex-wrap lg:mb-4 lg:mr-6'>
                                    <Image width={327} height={240} className='w-full md:w-1/2 lg:w-2/3 h-64 p-2 object-cover rounded-4xl lg:rounded-br-none' src={data['image3']} alt='image3' />
                                    <Image width={155} height={240} className='w-full md:w-1/2 lg:w-1/3 h-64 p-2 object-cover rounded-4xl lg:rounded-bl-none' src={data['image4']} alt='' />
                                </div>
                            </div>
                        </div>
                    </div>
