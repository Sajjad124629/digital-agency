    ...
    return (
        <div>
            <section>
                ...
                {data.map((item,key)=>{
                    return(
                        <div key={key} className="py-20 bg-gray-50 radius-for-skewed">
                                ...
                                <div className="w-full lg:w-1/2">
                                    <div className="mb-4 flex flex-wrap items-end">
                                        <div className="mb-4 lg:mb-0 w-full lg:w-2/3 px-3">
                                            <Image width={356} height={192} className="w-full h-32 lg:h-48 object-cover rounded" src={item['image1']}/>
                                        </div>
                                        <div className="w-full lg:w-1/3 px-3">
                                        <Image width={166} height={128} className="w-full h-32 lg:h-48 object-cover rounded" src={item['image2']}/>
                                        </div>
                                    </div>
                                    <div className="flex flex-wrap items-start">
                                        <div className="mb-4 lg:mb-0 w-full lg:w-1/3 px-3">
                                        <Image width={166} height={128} className="w-full h-32 lg:h-48 object-cover rounded" src={item['image3']}/>
                                        </div>
                                        <div className="w-full lg:w-2/3 px-3">
                                        <Image width={356} height={192} className="w-full h-32 lg:h-48 object-cover rounded" src={item['image4']}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
